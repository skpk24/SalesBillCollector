        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item"><a href="default.php?p=cGF5bWVudHMucGhw&from_date=<?php echo htmlspecialchars(date('d/m/Y 00:00')); ?>&to_date=<?php echo htmlspecialchars(date('d/m/Y 23:59')); ?>" class="nav-link<?php if(!empty($_GET['p']) && "cGF5bWVudHMucGhw" === $_GET['p']){?> active<?php } ?>"><i class="nav-icon bi bi-credit-card"></i><p>Payments</p></a></li>
