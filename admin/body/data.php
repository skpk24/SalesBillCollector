            ...
            <td colspan="9">
              <div class="float-end">
                <form action="dataExporter.php" method="GET">
                    ...
                    <button type="button" class="btn btn-primary" id="exportBtn">Export As CSV</button>
                </form>
              </div>
            </td>
          </tr>   
...
$(document).ready(function() {
    ...
    const salesman_select = <?php echo "'".$_GET['salesman']."'" ?? '[]'; ?>;
    const retailer_select = <?php echo "'".$_GET['retailer_name']."'" ?? '[]'; ?>;
    const bill_date_select = <?php echo "'".$_GET['bill_date']."'" ?? '[]'; ?>; 
    const beat_name_select = <?php echo "'".$_GET['beat_name']."'" ?? '[]'; ?>;
